...
def parse_args():
    ...
    parser.add_argument('--input_dir', default=r'/mnt/Data/qfl/Datasets/Desnowing/CSD/test2000', type=str,
                        help='Directory of validation images')
    parser.add_argument('--result_dir', default='./', type=str, help='Directory for results')
    parser.add_argument('--weights', default=r'../Pretrained/CSD.pth', type=str,
...
def main():
    ...
    yaml_file = '../options/test/DeSnowing/RouteWinFormer-{}-width48.yml'.format('CSD')
    with open(yaml_file, 'r') as f:
        x = yaml.load(f, Loader=yaml.Loader)

    s = x['network_g'].pop('type')

    model_restoration = RouteWinFormerLocal(**x['network_g'], factor_h=1.7, factor_w=1.7)
