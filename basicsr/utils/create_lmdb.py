...
def create_lmdb_for_reds():
    ...
    folder_path = '/mnt/Data/qfl/Datasets/REDS/train/train_sharp'
    lmdb_path = '/mnt/Data/qfl/Datasets/REDS/train/train_sharp.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/mnt/Data/qfl/Datasets/REDS/train/train_blur_jpeg'
    lmdb_path = '/mnt/Data/qfl/Datasets/REDS/train/train_blur_jpeg.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)


def create_lmdb_for_gopro():
    folder_path = '/mnt/Data/qfl/Datasets/GoPro/train/blur_crops'
    lmdb_path = '/mnt/Data/qfl/Datasets/GoPro/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/mnt/Data/qfl/Datasets/GoPro/train/sharp_crops'
    lmdb_path = '/mnt/Data/qfl/Datasets/GoPro/train/sharp_crops.lmdb'
