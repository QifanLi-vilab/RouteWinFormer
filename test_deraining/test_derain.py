...
parser = argparse.ArgumentParser(description='Image Deraining using RouteWinFormer')

parser.add_argument('--input_dir', default=r'/mnt/Data/qfl/Datasets/Deraining/Rain/test/', type=str,
                    help='Directory of validation images')
parser.add_argument('--result_dir', default='./', type=str, help='Directory for results')
parser.add_argument('--weights', default=r'../Pretrained/DeRain.pth', type=str,
                    help='Path to weights')

args = parser.parse_args()

####### Load yaml #######
yaml_file = '../options/test/DeRaining/RouteWinFormer-DeRaining-width64.yml'
import yaml
